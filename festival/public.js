...
function homeBtnGlow() {
  TweenLite.set(homebtn2, {
    scale: 1.1,
    alpha: 0
  })
  TweenLite.to(homebtn2, 1, {
    scale: 1.45,
    alpha: 1,
    overwrite: 0,
...
function moveBar() {
  for (var i = 0; i < 18; i++) {
    TweenLite.to(barA[i], .25 + Math.random(), {
      scaleY: Math.random()
    })
  };
  TweenLite.set(barA[0], {
    onComplete: moveBar,
    delay: .25
  })
}
...
function setBoy() {
  ...
  for (var i = 1; i <= 70; i++) { //站起来 0-69--70
    if (i < 10) {
      str = "//image.giccoo.com/projects/your_own_way/img/standup/man000" + i + ".png"
    } else {
      str = "//image.giccoo.com/projects/your_own_way/img/standup/man00" + i + ".png"
    }
    boyA.push(str)
  };
  for (var j = 1; j <= 41; j++) { //跳 70-110--41
    if (j < 10) {
      str = "//image.giccoo.com/projects/your_own_way/img/jump_s/man000" + j + ".png"
    } else {
      str = "//image.giccoo.com/projects/your_own_way/img/jump_s/man00" + j + ".png"
    }
    boyA.push(str)
  };
  for (var k = 1; k <= 69; k++) { //走 111-179--69
    if (k < 10) {
      str = "//image.giccoo.com/projects/your_own_way/img/walk/man000" + k + ".png"
    } else {
      str = "//image.giccoo.com/projects/your_own_way/img/walk/man00" + k + ".png"
    }
    boyA.push(str)
  };
  for (var l = 1; l <= 15; l++) { //走 180-194--15
    if (l < 10) {
      str = "//image.giccoo.com/projects/your_own_way/img/startrun/man000" + l + ".png"
    } else {
      str = "//image.giccoo.com/projects/your_own_way/img/startrun/man00" + l + ".png"
    }
    boyA.push(str)
  };
  for (var m = 2; m <= 20; m++) { //走 195-213--19
    if (m < 10) {
      str = "//image.giccoo.com/projects/your_own_way/img/run/man000" + m + ".png"
    } else {
      str = "//image.giccoo.com/projects/your_own_way/img/run/man00" + m + ".png"
    }
    boyA.push(str)
  };
  for (var n = 1; n <= 30; n++) { //飘 214-243--30
    if (n < 10) {
      str = "//image.giccoo.com/projects/your_own_way/img/fall/man000" + n + ".png"
    } else {
      str = "//image.giccoo.com/projects/your_own_way/img/fall/man00" + n + ".png"
    }
    boyA.push(str)
  };
  //想 244-244--1
  ...
  for (var o = 70; o >= 1; o--) { //坐下 245-314--70
    if (o < 10) {
      str = "//image.giccoo.com/projects/your_own_way/img/standup/man000" + o + ".png"
    } else {
      str = "//image.giccoo.com/projects/your_own_way/img/standup/man00" + o + ".png"
    }
    boyA.push(str)
  };
  //趴 315-315--1
  ...
  for (var p = 10; p <= 30; p++) { //坐下 316-336--21
    if (p < 10) {
      str = "//image.giccoo.com/projects/your_own_way/img/rain/man000" + p + ".png"
    } else {
      str = "//image.giccoo.com/projects/your_own_way/img/rain/man00" + p + ".png"
    }
    boyA.push(str)
  };
  //看 337-337--1
...
function setFlowerBlow() {
  ...
  for (var i = 1; i <= 54; i++) {
    if (i < 10) {
      str = "//image.giccoo.com/projects/your_own_way/img/flower/f000" + i + ".png"
    } else {
      str = "//image.giccoo.com/projects/your_own_way/img/flower/f00" + i + ".png"
    }
...
function flyingflower() {
  if (Math.random() > .93) {
    ...
    TweenLite.to(fc, 2 + Math.random() * 3, {
      x: -640 * ff.scaleX,
      rotation: Math.random() * 720 - 360,
      y: Math.random() * 800 + 200,
      onComplete: removeTar,
      onCompleteParams: [stage, fc]
    })

    // var if3=1
    // if(Math.random()>.7){if3=-1}

    TweenLite.to(ff, 2 + Math.random() * 3, {
      rotation: Math.random() * 720 - 360
    })
...
function showHomeBtn(_t) {
  TweenLite.to(homeBtn, 1, {
    alpha: 1,
    delay: _t
  })
  TweenLite.set($("#home_btn"), {
    display: "block",
    delay: _t
  })
}
...
function setQmark() {
  if (Math.random() > .5) { //Math.random()>.5//i=0;i<1;i++
    ...
    qMark.alpha = 0
    TweenLite.to(qMark, 2 + Math.random(), {
      x: (qMark.x + word2.x) / 2,
      scale: 0,
      y: qMark.y - (200 + Math.random() * 150),
      rotation: Math.random() * 180 - 90,
      alpha: 1,
      visible: "false",
      overwrite: 0
    })
    TweenLite.to(qMark, 1 + Math.random(), {
      alpha: 0,
      delay: .5,
      onComplete: removeTar,
      onCompleteParams: [stage_2, qMark]
    })
  };
}
//=====================激情+叛逆 字挪动
...
function setFire() {
  for (i = 0; i < 2; i++) { //Math.random()>.5//
    ...
    fire.alpha = 0
    TweenLite.to(fire, 2 + Math.random(), {
      x: (fire.x + word2.x) / 2,
      scale: 0,
      y: fire.y - (50 + Math.random() * 200),
      rotation: Math.random() * 180 - 90,
      alpha: 1,
      visible: "false",
      overwrite: 0,
      onComplete: removeTar,
      onCompleteParams: [stage_56, fire]
    })
...
function setBalloon() {
  ...
  TweenLite.to(balloon, 1, {
    ...
    alpha: 1,
    scale: 1,
    onComplete: balloon_loop1
  })
  TweenLite.to(balloon1, .5, {
    rotation: -15,
    onComplete: balloonBall_loop1
  })
  TweenLite.to(stage_7, 1, {
    y: 60,
    onComplete: stageLoop1
  })
  TweenLite.to(boy, 1, {
    y: boy.y + 60
  })

  TweenLite.to(skyMove, 4, {
    y: 0,
    x: -6
  })
...
function balloon_loop1() {
  if (ifLoop == 1) {
    TweenLite.to(balloon, 2, {
      rotation: 20,
      scale: 1,
      onComplete: balloon_loop2,
      ease: Sine.easeInOut
    })
  }
}
...
function balloonBall_loop1() {
  if (ifLoop == 1) {
    TweenLite.to(balloon1, 2, {
      rotation: 10,
      onComplete: balloonBall_loop2
    })
  }
}
...
function stageLoop1() {
  if (ifLoop == 1) {
    TweenLite.to(stage_7, 2, {
      y: -60,
      onComplete: stageLoop2,
      ease: Sine.easeInOut
    })
    TweenLite.to(boy, 2, {
      y: boy.y - 120,
...
function confuse() {
  for (i = 0; i < 1; i++) { //Math.random()>.5//i=0;i<1;i++
    ...
    TweenLite.to(word8, _t, {
      x: 0,
      scale: 0,
      y: 0,
      rotation: word8.rotation + 180,
      alpha: 1,
      visible: "false",
      overwrite: 0,
      ease: Sine.easeOut,
      onComplete: removeTar,
      onCompleteParams: [ctr, word8]
    })
    TweenLite.to(ctr, _t, {
      alpha: .25,
      rotation: ctr.rotation - 180,
      ease: Sine.easeOut,
      visible: "false",
      onComplete: removeTar,
      onCompleteParams: [stage_8, ctr]
    })
  };
}
...
function setRocket() {
  if (Math.random() > .0) {
    ...
    flame.y = word10.y + 55
    flame.alpha = .5
    TweenLite.to(flame, .8, {
      y: flame.y + 300 + 200,
      x: flame.x + Math.random() * 0 - 0,
      alpha: 0,
      visible: false,
...
function stepFall(_target) {
  if (ifStep == 1) {
    TweenLite.to(_target, 1, {
      x: 0 - Math.random() * stepR.x * 0,
      y: 840 + 50 + 400 + Math.random() * stepR.y * 0,
      rotation: Math.random() * stepR.deg - stepR.deg / 2,
      alpha: 0,
      ease: Linear.easeNone,
      visible: false
    })
...
function stepDisappear() {
  for (var i = stepA.length - 1; i >= 0; i--) {
    if (stepA[i].visible = true) {
      TweenLite.to(stepA[i], 1, {
        x: stepA[i].x - Math.random() * 500,
        y: stepA[i].y - 500 - Math.random() * 500,
        onComplete: removeTar,
        onCompleteParams: [stage_11, stepA[i]]
      })
    }
  };
}
...
function show14() {
  ...
  TweenLite.to(word14b, 1.5, {
    y: "+=50",
    x: 320 + 140,
    ease: Linear.easeNone,
    overwrite: 0
  })
  TweenLite.to(word13, .5, {
    y: "+=50",
    ease: Linear.easeNone,
    overwrite: 0
  })
...
function boysStop() {
  ...
  for (var i = 0; i < boys.length; i++) {
    TweenLite.to(boys[i], .9, {
      x: (boys.length - i) * 640 / boys.length + Math.random() * 10 - 105,
      y: "+=200",
      onComplete: showMV
    })
  }
  ...
  TweenLite.to(word15b, .9, {
    y: "+=200"
  })
  TweenLite.to(word15, .9, {
    y: "+=200",
    alpha: 0
  })
}
